...
const max_resume_size: number = Number(import.meta.env.VITE_MAX_RESUME_SIZE);
const FileUploader = ({ onFileSelect }: FileUploaderProps) => {
    ...
    const maxFileSize = max_resume_size * 1024 * 1024; // 20MB in bytes
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            PDF files up to {max_resume_size} MB
                        </p>
                    </div>
                </div>
            )}
